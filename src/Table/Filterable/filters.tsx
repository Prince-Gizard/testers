...
export const GlobalFilter: GlobalFilterT<any> = ({
...
export const DefaultColumnFilter: ColumnFilterT<any> = ({
...
// UI фильтра-слайдера
export const SliderColumnFilter: ColumnFilterT<any> = ({
...
export const NumberRangeColumnFilter: ColumnFilterT<any> = ({
...
export const SelectColumnFilter: ColumnFilterT<any> = ({
  column: { filterValue, setFilter, preFilteredRows, id },
}) => {
  // формируем варианты
...
export const fuzzyText: FilterType<any> = (rows, ids, filterValue) => {
...
export const filterGreaterThanOrEqual: FilterType<any> = (
  rows,
  ids,
  filterValue,
) => {
...
// типы фильтрации
export const filterTypes: FilterTypes<any> = {
  // добавляем новый тип
  fuzzyText,
